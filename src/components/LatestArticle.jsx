    ...
    return (
        ...
        <div className='bg-[#F7FCFC] xl:px-[65px] px-[25px] py-[50px]'>
            ...
            <div className='grid grid-cols-1 place-items-center mt-[53px]'>
                ...
                <button className='border self-center animate-bounce mt-[60px] rounded-md hover:bg-[#173F5F] hover:text-white transition-colors border-[#173F5F] text-[16px] px-[35px] py-[10px]'>Read All Articles</button>
            </div>
        </div>

        ...
        <Fade>
            <div className='bg-[#cee0e4] mx-[25px] xl:mx-[65px] my-[90px] grid grid-cols-1 md:grid-cols-3 gap-x-[50px] place-items-center overflow-hidden'>
                ...
                <div className='text-center md:mt-0 mt-[20px]'>
                    ...
                    <button className='mt-[40px] animate-bounce border rounded-md hover:bg-[#173F5F] hover:text-white transition-colors border-[#173F5F] text-[16px] px-[35px] py-[10px]'>Read More <ArrowRightAltIcon /></button>
                </div>
